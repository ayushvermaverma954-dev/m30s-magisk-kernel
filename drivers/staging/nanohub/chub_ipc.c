...
void *ipc_get_chub_map(void)
{
	...
	if (((unsigned long)ipc_addr[IPC_REG_PERSISTBUF].base + ipc_addr[IPC_REG_PERSISTBUF].offset) >
			((unsigned long)ipc_addr[IPC_REG_IPC].base + ipc_addr[IPC_REG_IPC].offset))
